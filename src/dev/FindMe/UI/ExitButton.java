...
public class ExitButton extends UIObject {
    ...
    public ExitButton(Handler handler, float x, float y, int width, int height, BufferedImage image){
    ...
    public void render(Graphics g) {
        if (visible) {
            ...
            TextDrawer.drawText(g, "Exit", (int) x + 47, (int) y + 17, true, Color.BLACK, Assets.pixelFont8);
        }
    }
